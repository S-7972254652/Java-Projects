	...
	<nav class="navbar navbar-expand-lg shadow  bg-body rounded"
		...
		<div class="container-fluid" id="main-logo">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				...
				<div class="main">
					...
					<div class="input-group">
						...
						<div class="input-group-append">
							<button class="btn btn-secondary btn-outline-none " style="padding: 10px" type="button">
				...
				<div class="one pe-5">
					<a href="checkout.jsp"><img src="images/wishlist.png" style="width: 40px; height: 40px;"
						alt=""></a>
			...
			<div class="col-md-3 mb-3">
				<div class="card crd-ho">
					<div class="card-body text-center">
						...
						<%}else{%>
							<a href="cart?pid=<%=p.getProductId() %>&&uid=<%=u.getId() %>" class="btn btn-danger btn-sm ml-2">Add Cart</a>
						<%}%>
