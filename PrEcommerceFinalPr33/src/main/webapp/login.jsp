	...
	<div
		...
		<form action="login" method="post" class="bg-white"
			...
			<label for="name" class="ms-3">Email:</label> <input
				...
				required="required"><br> <label for="name" class="ms-3">Password:</label>
			<input style="width: 300px; margin-left: 30px;" name="password"
				type="password" placeholder="Enter Your Password.."
				required="required">
			<p style="font-size: 13px; text-align: center; margin-top: 20px;">
				By Continung, I agree with the <a href="#"
					style="color: #d1025e; font-weight: bolder;">Terms Of Use</a> & <a
					href="#" style="color: #d1025e; font-weight: bolder;">Privacy
					Policy</a>
			</p>
			<div style="text-align: center;">
				<button
					style="border: none; background-color: #d1025e; width: 300px; text-align: center; padding: 10px; color: #fff; margin-bottom: 60px; margin-top: 20px;">Login</button>
			</div>
			<a href="Register.jsp"
				style="margin-left: 200px; margin-top: 50px; text-decoration: none;">New
				to Runstore? Create an account</a>
		</form>
	</div>
	<!-- !Login Form End -->
</body>
