			...
			<div class="col-md-4 offset-md-4 mt-5">
				<div class="card">
					...
					%>
						...
						<input type="text" style="width: 90%" name="pname" required="required" value="<%=p.getProductname()%>">
						</div>
						<div class="form-group">
						<label>Category:</label><br>
						<input type="text" style="width: 90%" name="category" required="required" value="<%=p.getProductCategory()%>">
						</div>
						<div class="form-group">
						<label>Quantity:</label><br>
						<input type="text" style="width: 90%" name="quantity" required="required" value="<%=p.getQuantity()%>">
						</div>
						<div class="form-group">
						<label>Price:</label><br>
						<input type="text" style="width: 90%" name="price" required="required" value="<%=p.getPrice()%>">
						</div>
						<div class="form-group">
						<label>Description:</label><br>
						<input type="text" style="width: 90%;" name="description" required="required" value="<%=p.getDescription()%>">
						</div>
						<div class="form-group">
						<label>Book Status:</label><br>
						<select id="inputState" name="status" class="form-control" style="width: 90%;" required="required" value="<%=p.getStatus()%>">
