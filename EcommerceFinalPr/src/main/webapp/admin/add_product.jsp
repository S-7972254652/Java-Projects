						...
						<form action="../add_products" method="post"
							...
							<div class="form-group">
								<label>Product Name:</label><br> <input type="text"
									style="width: 90%" name="pname" required="required">
							</div>
							<div class="form-group">
								<label>Category:</label><br> <input type="text"
									style="width: 90%" name="category" required="required">
							</div>
							<div class="form-group">
								<label>Quantity:</label><br> <input type="text"
									style="width: 90%" name="quantity" required="required">
							</div>
							<div class="form-group">
								<label>Price:</label><br> <input type="text"
									style="width: 90%" name="price" required="required">
							</div>
							<div class="form-group">
								<label>Description:</label><br> <input type="text"
									style="width: 90%;" name="description" required="required">
							</div>
							<div class="form-group">
								<label>Book Status:</label><br> <select id="inputState"
									name="status" class="form-control" style="width: 90%;"
									required="required">
							...
							<button class="btn btn-primary mt-5">
								<a href="home.jsp" class="text-decoration-none text-white">Home</a>
							</button>
