...
<form action="" class="bg-white" style="width: 500px;">
  ...
  <input style="width: 300px;margin-left: 28px;margin-bottom: 20px;" name="mobile" type="email" placeholder="Enter Your Mobile.."><br>
  <label for="name" class="ms-3">Mobile:</label>
  <input style="width: 300px;margin-left: 46px;" name="fname" type="password" placeholder="Enter Your Password..">
