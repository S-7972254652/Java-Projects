			...
			<div class="col-md-4 offset-md-4 mt-5">
				<div class="card">
					<div class="card-body">
						...
						<input type="text" style="width: 90%" name="pname" required="required">
						</div>
						<div class="form-group">
						<label>Category:</label><br>
						<input type="text" style="width: 90%" name="category" required="required">
						</div>
						<div class="form-group">
						...
						<select id="inputState" name="status" class="form-control" style="width: 90%;" required="required">
