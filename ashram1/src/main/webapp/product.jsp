...
<body>
    <div class="d-flex align-item-center justify-content-start" style="background-color: #412236;">
        <div class="logo ms-5 p-3">
            <img src="logo-1.webp" width=133px height="77px" alt="">
        </div>
        <div class="nav-items">
            <ul>
        ...
        <div class="row">
            <div class="col-3">
                <div class="card" style="width: 18rem;">
                    <img src="i1.webp" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title mb-3">ACHING HEAD RUB™</h5>
                        <a class="card-text text-decoration-none text-dark fw-bolder one-2">$7.00</a>
                    </div>
                </div>
            </div>
            <div class="col-3">
                <div class="card" style="width: 18rem;">
                    <img src="i2.webp" class="card-img-top" alt="...">
                    <div class="card-body">
