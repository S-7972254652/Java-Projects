		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ms-auto">
					...
					<li class="nav-item mx-0 mx-lg-1"><a
						class="nav-link py-3 px-0 px-lg-3 rounded text-white fw-bold" href="cart.jsp">Cart</a></li>
					<li class="nav-item mx-0 mx-lg-1"><a
						class="nav-link py-3 px-0 px-lg-3 rounded text-white fw-bold" href="Logout">Logout</a></li>
					<li class="nav-item mx-0 mx-lg-1 bg-danger"><a
						class="nav-link py-3 px-0 px-lg-3 rounded  text-white fw-bold" href="Logout"><%=session.getAttribute("name") %></a></li>
				</ul>
			</div>
		</div>
	</nav>
...
<div class="image-cards">
    ...
    <div class="image-card" style="margin-top: 0px;padding: 10px;box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px;">
        ...
        <button class="bg-info p-2 border-0 text-white"><a class="text-decoration-none text-white" href="#">Add To Cart</a></button>
