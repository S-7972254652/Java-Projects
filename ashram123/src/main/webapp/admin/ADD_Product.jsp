...
<body>
    ...
    <div class="d-flex justify-content-center align-items-center mt-5"  >
        <form action="" style="border: 2px solid; padding: 50px;">
            ...
            <input type="number" name="pname"><br>
            <label for="photo" class="mt-3">Upload Photo</label><br>
            <input type="file">
            <div class="d-grid gap-2 mt-4 d-md-block">
                <button class="btn" style="background-color: #C2185B;color: #fff" type="button">ADD</button>
