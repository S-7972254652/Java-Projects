...
<form action="loginform" class="bg-white" style="width: 500px;">
  <h5 class="text-center mt-3 mb-4">Login OR Signup</h5>
  <label for="name" class="ms-3">Name:</label>
  <input style="width: 300px;margin-left: 54px;margin-bottom: 20px;" name="fname" type="text" placeholder="Enter Your Name.."><br>
  <label for="name" class="ms-3">Password:</label>
  <input style="width: 300px;margin-left: 30px;" name="fname" type="password" placeholder="Enter Your Password..">
  ...
  <input type="submit" style="border: none;background-color: #d1025e;width: 300px;text-align: center;padding: 10px;color: #fff;margin-bottom: 60px;margin-top: 20px;" value="Login">
  </div>
