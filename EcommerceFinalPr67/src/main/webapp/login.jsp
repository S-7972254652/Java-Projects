...
<form action="login" method="post" class="bg-white" style="width: 500px;height: 350px">
  ...
  <input style="width: 300px;margin-left: 54px;margin-bottom: 20px;" name="email" type="email" placeholder="Enter Your Email.." required="required"><br>
  <label for="name" class="ms-3">Password:</label>
  <input style="width: 300px;margin-left: 30px;" name="password" type="password" placeholder="Enter Your Password.." required="required">
  ...
  <button style="border: none;background-color: #d1025e;width: 300px;text-align: center;padding: 10px;color: #fff;margin-bottom: 0px;margin-top: 10px;">Login</button>
  </div>
  <a href="Register.jsp" style="margin-left: 200px;margin-top:50px;text-decoration: none;">New to Runstore? Create an account</a>
</form>
</div>
    <!-- !Login Form End -->
</body>
