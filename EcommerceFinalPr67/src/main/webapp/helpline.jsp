...
<nav class="navbar navbar-expand-lg shadow  bg-body rounded"
	...
	<img alt="" src="images/hcR.png">
	<h3 class="fw-bold text-success">24 * 7 Customer Service</h3>
	<h5 class="fw-bold text-danger">+91 7972254652</h5>
