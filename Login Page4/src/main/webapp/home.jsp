...
<td data-bs-toggle="modal" data-bs-target="#exampleModal"><%=resultSet.getString("id") %></td>
<td data-bs-toggle="modal" data-bs-target="#exampleModal"><%=resultSet.getString("fname") %></td>
<td data-bs-toggle="modal" data-bs-target="#exampleModal"><%=resultSet.getString("lname") %></td>
<td data-bs-toggle="modal" data-bs-target="#exampleModal"><%=resultSet.getString("email") %></td>
<td data-bs-toggle="modal" data-bs-target="#exampleModal"><%=resultSet.getString("password") %></td>
